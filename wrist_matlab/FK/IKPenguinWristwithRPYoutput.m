...
function [ q1alto, q1medio, q1basso, RPY_ ] = IKPenguinWristwithRPYoutput( locus_of_desired_pose )
% IK Penguin Wrist without Plots
% Output: q1alto, q1medio, q1basso in gradi ognuno e' vettore 1xN!!!;
%         RPY_ in degrees relative to the locus_of_desired_pose.
...
RPY_ = zeros(3,Num_Of_desired_pose);
