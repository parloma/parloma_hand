function arrowHandle = arrow3_new(pos, deltaValues, colorCode, stemRatio, rhoRatio)

% arrowHandle = arrow3_new(pos, deltaValues, colorCode, stemRatio) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %******************************************* CYLINDER == STEM *********************************************
    coneLength = stemRatio;%0.15; %$$$$MODIFICATO DA ME
    %     cylinderRadius = srho*rhoRatio
    cylinderRadius = rhoRatio;%0.0250;%$$$$MODIFICATO DA ME
    cylinderLength = srho-coneLength;
...
%     V = [0, 0, srho*stemRatio];    %---- centerline for cylinder: the multiplier is to set the cone 'on the rim' of the cylinder
    V = [0, 0, cylinderLength];    %---- centerline for cylinder: the multiplier is to set the cone 'on the rim' of the cylinder
